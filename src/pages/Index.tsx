                  ...
                  <div className="space-y-4">
                    <div className="bg-[#36393f] rounded-lg p-3 flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-[#b9bbbe] text-xs">Твой код: <span className="text-[#faa61a] font-mono font-bold">{refResult.ref_code}</span></div>
                      </div>
                    </div>
                    ...
                    {/* Топ участников */}
                    {!topLoaded && (
                      <Button variant="ghost" onClick={loadTop} className="w-full text-[#b9bbbe] hover:text-white hover:bg-[#40444b] text-sm">
